  ...
  return(
    <a href="#" className={"list-group-item list-group-item-action" +(active ? " active" : "")} aria-current="true" key = "{user.name}" >
        <div className="d-flex w-100 justify-content-between">
          ...
          <button onClick={ClickDelete} type="button" className={"btn btn-danger"}>Delete</button>    
          </>
...
function UserForm({createUser}){
  ...
  <div className="mb-3">
    ...
    <input ref={email} type="email" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"></input>
  </div>
  <div className="mb-3">
    <label ref={password} htmlFor="exampleInputPassword1" className="form-label">Password</label>
    <input type="password" className="form-control" id="exampleInputPassword1"></input>
  </div>
  <div className="mb-3">
    <label htmlFor="github-user" className="form-label">GitHub User</label>
    <input ref={githubUser} type="text" className="form-control" id="github-user"></input>
  </div>
